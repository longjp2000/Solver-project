c$Id: pltris.f,v 1.1 2006/11/20 20:33:12 rlt Exp $
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      integer   nsi,i,j,ii,ivc,jvc,nn,nnn
      integer   ix(nen1,*),ilc(4)
      real*8    s,dx1,x1,y1,z1,vv,vl,vu
      real*8    x(ndm,*),xl(3,*),v(*),vc(*),vt(4),xt(3,4)
...
c     Draw border around element
      ...
      else if(edgfl .and. ns.eq.5) then
        if(cont) call pppcol(5,1)
        call pedge4(4,ix,xl,nen1,n)
      endif
