c$Id: pstart.f,v 1.2 2006/12/09 21:17:29 rlt Exp $
      subroutine pstart()
...
c     Set maximum memory use: 0 = unlimited; > 0 maximum array size allocated
...
c     Get
      ...
      ofn%hInstance         = NULL      ! Set appropriate hInstance if desired
      ...
      ofn%lpstrTitle        = loc(DLGTITLE)   !Give title to the dialog box
