...
/*....  Copyright (c) 1984-2006: Regents of the University of California*/
/*                               All rights reserved                    */

/*----[--.----+----.----+----.-----------------------------------------]
 *    Modification log                                Date (dd-mm-year)
 *      Original version                                    01-11-2006
 *      1. Add option for IBM/HP compilers for cinput()     27-11-2006
 */
/*-----[--.----+----.----+----.-----------------------------------------*/
/*     Purpose: FEAP driver for X windows Version 11, Release 4.        */
...
/* FEAP's comfil common block */
struct { 
          char finp[128], fout[128], fres[128], fsav[128], 
          fplt[128], fmtl[128], fincld[1280], record[255]; 
} comfil_;
...
{
        int stlen;
        if ( NULL != fgets(comfil_.record,255,stdin) ) {
           stlen = strlen(comfil_.record);
           comfil_.record[stlen]   = ' ';
           comfil_.record[stlen-1] = ' ';
           return 1;
        }
        else {
           return 0;
