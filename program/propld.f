c$Id: propld.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
c             Type 4.
              ...
              elseif(ik(i).eq.4 .and. ap(4,i).eq.0.0d0) then
                write(iow,2004)
                if(ior.lt.0) then
                  write(*,2004)
                  go to 101
...
2003  format(/,' Number    Type      Tmin',10x,'Tmax',/i3,i10,7x,g10.4,
     & 4x,g10.4,/5x,'1-vel',9x,'2-vel',9x,'r-vel',9x,'1-ref',9x,'2-ref'
     &/4x,5(g10.4,4x)/)
