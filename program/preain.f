c$Id: preain.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
      subroutine preain(id,f,ul,ndf,numnp, name,prt,prth)
...
c         name       - File name to use for reads
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      character name*(*),fnamr*18,fext*3
