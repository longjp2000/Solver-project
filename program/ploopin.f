c$Id: ploopin.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      logical    pcomp, lopen
      character  lp_file*15,lp_ext*1, xxx*255,yyy*255
...
c         Establish new filename and save to current file
          ...
          lp_file(10:10) = lp_ext
          yyy(1:5)       = 'file='
          yyy(6:15)      = lp_file(1:10)
          write(lp_lun,1000) yyy(1:15)
