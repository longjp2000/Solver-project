c$Id: psolve.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
c         Conjugate gradient solver
            ...
            setvar = palloc(111,'TEMP1',5*neq,2) ! allocate temporary storage
            fp(5) = np(111)
            do i = 6,9
              fp(i) = fp(i-1) + neq
            end do ! i
     ...
     &                  neq,icgits,itol,rn,rn0,stype)
            ...
            setvar = palloc(111,'TEMP1', 0, 2) ! destroy temporary storage
