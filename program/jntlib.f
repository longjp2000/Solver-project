c$Id: jntlib.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
c         rcg(*,*,*) - Array describing center of mass locations and rates
c         rlam(*,*,*)- Array describing rotation array locations and rates
...
c         Flexible body point
          ...
          elseif(j2.lt.0) then
            ...
            n1 = abs(j2) - 1
            call defnod(hr(np(43)+n1*ndm),u(1,-j2),mr(np(31)+n1*ndf),
     &                   ld(1,3),x2)
            do i = 1,3
              y2(i)  = 0.0d0
              yh2(i) = 0.0d0
...
c           Lagrange multiplier equations
            ...
            call jrevo0(lam,x(1,1,n),rlam,ebig(1,1,nrev),alpr,
     &                  j1,j2,pr,sr)
...
c             Lagrange multiplier equations
              ...
              call jangl0(lam,angle(2),x(1,3,n),rlam,ebig(1,1,nrev),
     &                    j1,j2,pr,sr)
...
c             Lagrange multiplier equations
              ...
              call jdisp0(lam,x(1,3,n),rlam,ebig(1,1,nrev),x1,
     &                   xh2,x2,rh1,r1,rh2,r2,j1,pr,sr)
