c$Id: conjgd.f,v 1.2 2006/12/14 01:52:35 rlt Exp $
...
c                        algorithm, Ph.D. Dissertation, Stanford, March 1989.
c      Inputs:
c         ad(*)    - Diagonal entries of coefficient matrix
c         ac(*)    - Compressed part of symmetric coefficient matrix
c         jpr(*)   - Pointer array for columns/rows of block precond. array
c         x(*)     - Residual
