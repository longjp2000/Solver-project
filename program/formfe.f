c$Id: formfe.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
c     Add concentrated nodal terms: stiffness, damping, mass
      ...
      if(nmfl) then
        call pnodal(mr(np(31)),hr(np(88)),hr(np(86)),hr(np(87)),
...
c     Add concentrated radial follower forces
      ...
      if(nffl) then
        call pnforc(mr(np(31)),mr(np(29)),hr(np(256)),
...
c       Shifts to local arrays for second element
     ...
     &              hr(np(36)),mr(np(32)),hr(np(25)),mr(np(31)),
...
c     User contributions
      ...
      call uformfe(pnu,pna,pnl,pnb,aufl,alfl,bfl,dfl,isw,nl1,nl2,nl3)
