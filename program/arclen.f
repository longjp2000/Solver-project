c$Id: arclen.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      integer   i,j,jj,ndf
      integer   id(ndf,*)
      real*8    time, cs,ds,dcs,damp,dot,rr,rat
...
c       Change sign if stiffness parameter passes infinity or limit point
