c$Id: cassem.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
      subroutine cassem(ad, au, al, s, ir, jc, ip, ld, nst, alfl,
     &                  bycol,diagin,all)
...
c         ip(*)   - Inverse pointer from minimum degree reordering
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      integer  nst, i,j,k,n, inz,inza, jc(*),ir(*),ip(*), ld(*)
