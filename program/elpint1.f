c$Id: elpint1.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
c-----[--.----+----.----+----.-----------------------------------------]
c     Purpose: Construct one dimensional elipse interpolation for coords.
...
c     Interpolate angles

      call interp1(nr,rs, side,isr,ns-1,ndm,shp, x)

c     Compute x-y for elipse interpolations
