c$Id: optrm.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
c               Only check contact elements with greater/equal number nodes
...
c         Check contact elements which have less than maximum number nodes
