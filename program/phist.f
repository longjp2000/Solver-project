c$Id: phist.f,v 1.1 2006/11/20 20:32:37 rlt Exp $
...
3000  format(' *ERROR* PHIST: Not that many items in list, nn =',i4)

3001  format(' *ERROR* PHIST: No items in list, nn = ',i3)
