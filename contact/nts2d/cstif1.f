c$Id: cstif1.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
      subroutine cstif1 (cp0,ch2,ch3,nsiz,tanm,resv)
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      real*8    cp0(nr0,n0c3:*),ch2(*),ch3(*),tanm(nsiz,*),resv(*)
...
c     Check on sign of contact force if > 0 set to zero
      ...
      if(fn.gt.0.0d0) then
        ...
        return                  ! N.B. Will assemble a zero tangent/residual
      endif
...
c       REMARK - stiffness matrix should be passed always completely full
...
c         Compute ft * d21o/d21**2 * [-[T0xTs - TSxT0] + [NSxN0 + N0xNS] -
