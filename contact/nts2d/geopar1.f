c$Id: geopar1.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      real*8    x(ndm,*),u(ndf,*),cxs(*),cp0(nr0,n0c3:*), augfn
...
c     Tangent vector t
c     REMARK - s21 and c21 normalized at the end to minimize numerical errors
