c$Id: defhvptp.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c         xi      - normalized projection of slavenode on segment  (xic,etac)
...
c     CH1 & CH2 VARIABLES (dynamic, CH2 copied in CH1 at every time step)
