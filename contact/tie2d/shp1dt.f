c$Id: shp1dt.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c                   shp(1,1 to nel): first  derivatives of shape functions
c                   shp(2,1 to nel): shape functions
c                   shp(3,1 to nel): second derivatives of shape functions
c-----[--.----+----.----+----.-----------------------------------------]
      implicit  none
