c$Id: ctied2d.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c             Set master reference point
              ...
              slavfl = slavt2( cxm,zs,nel,xi2 )
              xi1 = min( 1.d0,xi1)
              xi2 = max(-1.d0,xi2)
              if(slavfl .or. masfl) then
                js(2) = nel*ndf
                do l = 1,lint
...
c-----[--.----+----.----+----.-----------------------------------------]
c     History variables initialization                                        c
