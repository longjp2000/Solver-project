c$Id: criggap.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c-----[--.----+----.----+----.-----------------------------------------]
c     Purpose: Compute active elements and residual and tangent for node
...
c         Transform to global frame
          ...
          do i = 1,ndm
            r(i) = (tr(i,1)*rl(1) + tr(i,2)*rl(2) + tr(i,3)*rl(3))
          end do ! i
