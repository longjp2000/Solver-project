c$Id: formfkt.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c      Purpose: Compute shape functions and derivatives for facet point.
...
c     niab(k,i)     =  Derivative of shape function with respect xi(i)
      ...
      niab(2,1)     =  0.25d0*xi2m
      niab(3,1)     =  0.25d0*xi2p
      niab(4,1)     = -0.25d0*xi2p
      niab(1,2)     = -0.25d0*xi1m
      niab(2,2)     = -0.25d0*xi1p
      niab(3,2)     =  0.25d0*xi1p
      niab(4,2)     =  0.25d0*xi1m

c     niabab(k,i,j) =  Derivative of shape function with respect xi(i), xi(j)
