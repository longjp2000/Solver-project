c$Id: celmt02.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
      subroutine celmt02 (ndm,ndf,x,u,
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      call cdebug0 ('    celmt02',csw)

      if ((csw.ne.0).and.(csw.ne.200).and.(csw.ne.400)) write (*,3001)

3001  format (' WARNING - dummy contact element CELMT02 called')
