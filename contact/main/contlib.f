c$Id: contlib.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c     Automatic sel. performed in normal operations
        ...
        call setcomp (npair,cs0,cm0,cp0,hic)
        ndv    =  ndrv
        ifscan = .false.
      endif
...
c       User Contact Element Type 1
        ...
        if (ndv.eq.1) then
          call celmt01 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
...
c       User Contact Element Type 2
        ...
        elseif (ndv.eq.2) then
          call celmt02 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 3
        ...
        elseif (ndv.eq.3) then
          call celmt03 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 4
        ...
        elseif (ndv.eq.4) then
          call celmt04 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 5
        ...
        elseif (ndv.eq.5) then
          call celmt05 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 6
        ...
        elseif (ndv.eq.6) then
          call celmt06 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 7
        ...
        elseif (ndv.eq.7) then
          call celmt07 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 8
        ...
        elseif (ndv.eq.8) then
          call celmt08 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 9
        ...
        elseif (ndv.eq.9) then
          call celmt09 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 10
        ...
        elseif (ndv.eq.10) then
          call celmt10 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 11
        ...
        elseif (ndv.eq.11) then
          call celmt11 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 12
        ...
        elseif (ndv.eq.12) then
          call celmt12 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 13
        ...
        elseif (ndv.eq.13) then
          call celmt13 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 14
        ...
        elseif (ndv.eq.14) then
          call celmt14 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 15
        ...
        elseif (ndv.eq.15) then
          call celmt15 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 16
        ...
        elseif (ndv.eq.16) then
          call celmt16 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 17
        ...
        elseif (ndv.eq.17) then
          call celmt17 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 18
        ...
        elseif (ndv.eq.18) then
          call celmt18 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 19
        ...
        elseif (ndv.eq.19) then
          call celmt19 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       User Contact Element Type 20
        ...
        elseif (ndv.eq.20) then
          call celmt20 (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf1),cs0(1,n0c1,nsurf2),
     &                  cm0(1,n0c2,nmat1), cm0(1,n0c2,nmat2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),cm(ofm1),cm(ofm2),
...
c       Program Contact Element Type NToS
        ...
        elseif (ndv.eq.21) then
          if(ndm.eq.2 .or. cndm.eq.2) then
            call cnts2d (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                   cs0(1,n0c1,nsurf2),
     &                   cp0(1,n0c3,npair),
     ...
     &                   w1(1,ndv),w3(1,ndv))
          elseif(ndm.eq.3) then
            call cnts3d (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                   cp0(1,n0c3,npair),
     &                   ics(ofs1),ics(ofs2),cm(ofm1),
     &                   ch1(ofh1),ch2(ofh1),ch3(ofh3),
     &                   w1(1,ndv),w3(1,ndv))
...
c       Program Contact Element Type PToP or NToN Problems
        ...
        elseif (ndv.eq.22 .or. ndv.eq.23) then
          call cptpnd (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
...
c       Program Contact Element Type PToR or NToR Problems
        ...
        elseif (ndv.eq.24 .or. ndv.eq.25) then
          call cntrnd  (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),
     &                  ch1(ofh1),ch2(ofh1),ch3(ofh3),
...
c       Program Contact Element Type PToR or NToR Problems
        ...
        elseif (ndv.eq.26) then
          call ctied2d (ndm,ndf,hr(np(43)),hr(fp(1)),csw,npair,
     &                  cs0(1,n0c1,nsurf2),
     &                  cp0(1,n0c3,npair),
     &                  ics(ofs1),ics(ofs2),
     &                  ch1(ofh1),ch2(ofh1),ch3(ofh3),
