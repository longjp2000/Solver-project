c$Id: crblen.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      logical   gettd, wdflg,gapfl, errck
      integer   nope,dnope,neps,nsopt, i,i1,i2,i2last,j,n,jsw
...
c       Set coordinates for surface search
        ...
        do while (wdflg)
          ...
          if(errck) then
            ...
            write(iow,2001) (is(i),i=1,i2)
            j = 180
            call pside1(j,xs,tr,1,is(2),i2-1,ndm,shp,rt,xr,is(1))
