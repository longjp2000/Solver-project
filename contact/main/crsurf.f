c$Id: crsurf.f,v 1.1 2006/11/20 20:32:46 rlt Exp $
...
c         lcs1    - Length of facet array LCS
c-----[--.----+----.----+----.-----------------------------------------]
      implicit  none
