c$Id: pdsaitr.f,v 1.1 2006/11/20 20:43:46 rlt Exp $
...
c           %--------------------------------------%
            ...
            call pdgetv0 (ido, bmat, itry, .false., n, j, v, ldv,
...
c        %------------------------------------------%
     ...
     &                  workd(irj), 1)
         ...
         call pfeapsr(workd(irj),tbuf,j) ! Communicate with other processors
