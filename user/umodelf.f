c$Id: umodelf.f,v 1.1 2006/11/20 20:33:27 rlt Exp $
      subroutine umodelf(umat,f,finv,df,detf,be,ta,d,ud,hn,h1,nh,
     &                   ntm,istrt, sig,dd, xlamd,ha, isw)
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      real*8     hn(nh),h1(nh), sig(6),dd(6,6)
