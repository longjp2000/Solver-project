c$Id: plate2q.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
...
c                                  4 internal bubble for rotational fields
...
c     Compute shears
      ...
      real*8    co(4),si(4),jac0(2,2),an(32),sg(3,9)
      real*8    jac(2,2),jinv(2,2),shp(3,4),shpm(3,4),shpn(3)
      real*8    xsj,ccm,clm, ar24
...
c       Consistent mass matrix part
        ...
        do i=1,4
          ...
          k        = mod(j,4) + 1
          an(i1  ) = shp(3,i)
          an(i1+1) = shpm(3,i)*co(i) - shpm(3,k)*co(k)
          an(i1+2) = shpm(3,i)*si(i) - shpm(3,k)*si(k)
          i1 = i1 + ndf
        end do ! i
