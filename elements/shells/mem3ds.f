c$Id: mem3ds.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
...
c- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      ...
      real*8    yl(3,4),vl(6,4),tr(3,3),bl(3),bf(3),bg(3),bt(3,3)
      real*8    pm(12),sm(12,12),el(3),x3(3), dd(6,6,5)
...
c         Compute symmetric block
      ...
      real*8    vl(6,4),eps(6),norm(6),dd(6,6),dvl(4)
...
c     Elastic behavior
      ...
      if(nint(d(40)).eq.0) then
        ...
        nhv   = nint(d(15))
        istrt = nint(d(84))
        call modlsd(d,ta,eps,hr(nh1),hr(nh2),nhv,istrt,dd,sigt,isw)
      endif
