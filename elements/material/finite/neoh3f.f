c$Id: neoh3f.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
      subroutine neoh3f(d,f,finv,detf,bb, hn,ntm, sig,aa,xlamd,ha,engy)
...
c     1. Plasticity
      ...
      if(d(40).eq.1.d0) then

c     2. Viscoelasticity

      elseif(d(40).eq.2.d0) then

        call viscfd(d,f,finv,detf,hn(1),hn(2),hn(2+ntm),ntm, sig,aa)
