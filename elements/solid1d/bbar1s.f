c$Id: bbar1s.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
...
c        shp(2,4,*)    - Shape functions and derivatives
...
c        bbar(4,*)     - Mixed volumetric derivatives of shape functions.
c                        (N.B. Includes axisymmetric part using irad(*))
c-----[--.----+----.----+----.-----------------------------------------]
      implicit  none

      integer   lint,   nel,  npm,   i,  j,  k, l
      real*8    shp(2,4,*),  dvol(*)  ,  ht(3,2),   h1
      real*8    gg(3,4) ,  hh(3,3)    ,  hv(3,2)   ,  hg(3,16)
      real*8    irad(*)    ,  phi(3,4) ,  theta(3,*),  bbar(4,*)
