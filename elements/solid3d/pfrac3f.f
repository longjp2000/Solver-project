c$Id: pfrac3f.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
      subroutine pfrac3f(f,detf,sig,weng,shp,dvol, r,lint,ndf,ndm,ntyp)
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      real*8     f(3,3,2,*),detf(2,*), shp(4,8,*),dvol(*), r(ndf,*)
...
c       Convert shape function derivatives to material form
        ...
        if(ntyp.eq.3) then
          do k = 1,nel
            thi        = shp(1,k,l)*f(1,1,1,l)
     &                 + shp(2,k,l)*f(2,1,1,l)
     &                 + shp(3,k,l)*f(3,1,1,l)
            thj        = shp(1,k,l)*f(1,2,1,l)
     &                 + shp(2,k,l)*f(2,2,1,l)
     &                 + shp(3,k,l)*f(3,2,1,l)
            shp(3,k,l) = shp(1,k,l)*f(1,3,1,l)
     &                 + shp(2,k,l)*f(2,3,1,l)
     &                 + shp(3,k,l)*f(3,3,1,l)
            shp(1,k,l) = thi
            shp(2,k,l) = thj
