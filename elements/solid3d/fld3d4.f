c$Id: fld3d4.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
...
c-----[--.----+----.----+----.-----------------------------------------]
c     Putpose: St. Venant - Kirchhoff Material Model
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      real*8   f(3,3), ee0(6), ss0(6), ss(6,8), dd(6,6), ee(6), spr(3)
...
c       Compute Green-Lagrange strain
        ...
        call modl3d4(d,detf,f, dd,ss(1,l),ee,.false.)

        if(isw.eq.4) then

          do i = 1,6
            ss0(i) = ss0(i) + 0.125d0*ss(i,l)
            ee0(i) = ee0(i) + 0.125d0*ee(i)
          end do ! i
