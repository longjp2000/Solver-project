c$Id: pjint3d.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
      subroutine pjint3d(ul,th,shp,dvol,epsv,sig,p,ndf,ndm,lint,nes)
...
c-----[--.----+----.----+----.-----------------------------------------]
c      Purpose: J-integral/Matrial Force Calculations for linear elements
...
c-----[--.----+----.----+----.-----------------------------------------]
      ...
      integer    ndf,ndm, i,j,k,l, lint,nes
      real*8     ul(ndf,nen),th(*),p(ndf,*)
      real*8     shp(4,nes,*),dvol(*),sig(10,*),epsv(*)
...
c     Set nodal potential values: Can be specified or computed
      ...
      do l = 1,lint
        ...
        call grad3d(ul,shp(1,1,l),epsv(l),ndf,nel,gradu)
