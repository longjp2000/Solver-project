c$Id: bbar3m.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
      subroutine bbar3m(phi,shp,dvol,xji,lint,nel,npm,
     &                  hh,theta,shpbar)
...
c     Inputs:
c        shp(4,27,*)    - Shape functions and derivatives at gauss points
...
c     Outputs:
c        hh(4,4)        - Reference configuration shape integrals (inverse)
c        theta(2,*)     - Mixed jacobian determinant for element
c        shpbar(3,27,*) - Mixed derivatives of shape functions.
c-----[--.----+----.----+----.-----------------------------------------]
      implicit  none

      integer   lint, nel, npm, i, j, k, l
      real*8    phi(4,*),shp(4,27,*),dvol(*),theta(2,*)
      real*8    shpbar(3,27,*),gg(4,3,27),hh(4,4),ji(4,3),xji(2,*)
      real*8    hj(4,3), hg(4,3,27), voln,h0,h1,h2
