c$Id: franf3d.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
...
c     Initialize history variables
      ...
      elseif(isw.eq.14) then
        ...
        do ll = 1,nel+1
          do i = 1,ii
            call modl1d(d,le,xx,hr(n1),hr(n2),nh,1,0,
     &                  aa,sig,isw)
            n1 = n1 + nh
            n2 = n2 + nh
          end do ! i
...
c             Call beam 3d model
              ...
              call bm3mat(d,hr(n1),hr(n2),nh,epsl,sigl,cc,isw)
...
c         Premultiply result by transpose of transformation array
      ...
      subroutine bm3mat(d,hn,h1,nh,eps,sig,aa,isw)

      implicit   none
      integer    nh, isw,i,j
      real*8     d(*),hn(*),h1(*),eps(6),sig(6),aa(6,6),g
...
c     Integrated models
        ...
        call bm3res(d,hn,h1,nh,eps,sig,aa,isw)
      endif
