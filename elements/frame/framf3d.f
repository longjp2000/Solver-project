c$Id: framf3d.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
...
c       Set element plot information
     ...
     &               + (xl(3,2) - xl(3,1))**2)
            ...
            do j = 1,nel
              do im = 1,3
                ...
                s(jj+im,jj+im) = s(jj+im,jj+im)        + xmr
              end do ! im
            end do ! j
...
c     Compute strain and stress
      ...
      real*8   cn(3,3),cm(3,3),cnm(3,3),te(3,3),xlam0(3,3),tmp(3)
