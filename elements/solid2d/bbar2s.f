c$Id: bbar2s.f,v 1.1 2006/11/20 20:32:56 rlt Exp $
...
c        shp(3,9,*)    - Shape functions and derivatives
...
c        bbar(2,16,*)  - Mixed volumetric derivatives of shape functions.
c                        (N.B. Includes axisymmetric part using irad(*))
c-----[--.----+----.----+----.-----------------------------------------]
      implicit  none

      integer   lint,   nel,  npm,   i,  j,  k, l
      real*8    shp(3,16,*),  dvol(*)   ,  ht(6,2),   h1
      real*8    gg(6,2,16) ,  hh(6,6)   ,  hv(6,2)   ,  hg(6,2,16)
      real*8    irad(*)    ,  phi(6,25) ,  theta(3,*),  bbar(2,16,*)
